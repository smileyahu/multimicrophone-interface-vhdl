...
entity rx_i2s_topm is
   ...
   port (
      ...
      i2s_sd_i  : in  std_logic;        -- I2S data input -- Somthing is wrong
...
architecture rtl of rx_i2s_topm is
   ...
   signal i2s_sck_o_sig                      : std_logic;
   signal i2s_ws_o_sig                       : std_logic;
...
-- Receive decoder
   ...
   DEC : i2s_codec
      ...
      port map (
         ...
         i2s_sd_o     => open,
         --i2s_sck_o    => i2s_sck_o,
         i2s_sck_o    => i2s_sck_o_sig,
         --i2s_ws_o     => i2s_ws_o);
         i2s_ws_o     => i2s_ws_o_sig);   
